...
import { createMessageItemStyles } from '@/theme/createMessageStyles';
...
const MessageItem = ({
  ...
  const styles = useMemo(
    () => createMessageItemStyles(colors, width),
    [colors],
  );
  ...
  const hasReactions = Boolean(item.reactions?.length);
